...
public class products extends javax.swing.JInternalFrame {
    ...
    public products() {
        ...
        public void mouseEntered(java.awt.event.MouseEvent evt) {
            ...
            setCursor(cu);
            btnAdd.setBackground(new java.awt.Color(98,200,50));
         }
 ...
 class deleteAction extends AbstractAction {
  ...
  @Override public void actionPerformed(ActionEvent e) {
    ...
    SystemClass.removeProduct(table.getModel().getValueAt(table.getSelectedRow(),0).toString());
...
class EditAction extends AbstractAction {
  ...
  @Override public void actionPerformed(ActionEvent e) {
      String barcode=table.getModel().getValueAt(table.getSelectedRow(),0).toString();
      System.out.println(barcode);
      newProduct frm=new newProduct(products.this,barcode);
      frm.setVisible(true);
  }
}
class ButtonsEditor extends AbstractCellEditor implements TableCellEditor {
  ...
  @Override public Object getCellEditorValue() {
    ...
    public void addRowTable(){
        ...
        ArrayList<Product> list=SystemClass.getAllProduct();
           ...
           Object rowdata[]=new Object[7];
            ...
            rowdata[0]=list.get(i).getBarkod();
            rowdata[1]=list.get(i).getName();
            rowdata[2]=list.get(i).getP_price();
            rowdata[3]=list.get(i).getS_price();
            rowdata[4]=list.get(i).getAmount();
            rowdata[5]=list.get(i).getDescription();
            rowdata[6]=list.get(i).getCategory();
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 7, 80, 30));
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 760, 42));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Barcode", "Name", "Purchase Price", "Sale Price", "Amount", "Description", "Category", "Action"
            }
        ) {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 730, 350));
        ...
        txtBarcode.setText("Enter barcode");
        ...
        jPanel1.add(txtBarcode, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 730, 40));
    ...
    private void btnAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddMouseClicked
        new newProduct(this,null).setVisible(true);
    ...
    private void txtBarcodeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBarcodeKeyPressed
        ...
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            try {
             ...
             Product p=SystemClass.getProduct(txtBarcode.getText());
           
           Object rowdata[]=new Object[7];
           
            rowdata[0]=p.getBarkod();
            rowdata[1]=p.getName();
            rowdata[2]=p.getP_price();
            rowdata[3]=p.getS_price();
            rowdata[4]=p.getAmount();
            rowdata[5]=p.getDescription();
            rowdata[6]=p.getCategory();   
            model.addRow(rowdata);
            p=null; 
            } 
            catch (Exception e) {
                JOptionPane.showMessageDialog(this,"THE PRODUCT IS NOT FOUND!");
            }   
       }
